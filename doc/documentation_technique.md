...
## binary_converter.c
Gère la sauvegarde et le chargement des quadtrees au format binaire.
...
- `save_node` : Fonction récursive pour sauvegarder chaque nœud.
- `load_node` : Fonction récursive pour charger chaque nœud.

## c_tree.c
Gestion des arbres colorés.
...
## bw_tree.c
Gestion des arbres en noir et blanc.
...
## minimizer.c
Les minimisations des quadtrees (Avec et Sans pertes).

### Fonctions principales
- `minimize_identical_leaves_in_node` : Minimise les feuilles identiques en les combinant.
- `minimize_unique_leaves` : Minimise les feuilles en ne gardant qu'une seule feuille par couleur.
